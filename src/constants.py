...
class Constants:
	...
	def computeConstants(self,c):
		...
		INITIAL_SF_KCALS = TONS_DRY_CALORIC_EQIVALENT_SF*4e6/1e9 # billion kcals per unit mass initial
		...
		# INITIAL_SF_FAT = c['inputs']['INITIAL_SF_FAT'] #1000s tons
		# INITIAL_SF_PROTEIN = c['inputs']['INITIAL_SF_PROTEIN'] #1000s tons
		# SF_FRACTION_FAT = INITIAL_SF_FAT/INITIAL_SF_KCALS
		# SF_FRACTION_PROTEIN = INITIAL_SF_PROTEIN/INITIAL_SF_KCALS
