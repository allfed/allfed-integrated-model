...
class Parameters:
    ...
    def computeParameters(self, constants):
        ...
        (biofuels_kcals, biofuels_fat, biofuels_protein) \
         = biofuels.get_biofuel_usage(inputs_to_optimizer)


        #### FEED VARIABLES ####
        feed = Feed(inputs_to_optimizer)
        (biofuels_kcals, biofuels_fat, biofuels_protein) \
         = feed.get_feed_usage(inputs_to_optimizer)
        ...
        greenhouse_area = \
            greenhouses.get_greenhouse_area(
                inputs_to_optimizer,
                outdoor_crops
            )
        ...
        crops_food_produced = \
            outdoor_crops.get_crop_production_minus_greenhouse_area(
                inputs_to_optimizer,
                greenhouses.greenhouse_fraction_area
            )
        ...
        time_consts["crops_food_produced"] = \
            crops_food_produced  # no waste
        ...
        time_consts["production_fat_fish_per_month"] = \
            production_fat_fish_per_month
        time_consts["production_kcals_CS_per_month"] = \
            production_kcals_CS_per_month
        ...
        constants['OG_ROTATION_FRACTION_KCALS'] = \
            outdoor_crops.OG_ROTATION_FRACTION_KCALS
        constants['OG_ROTATION_FRACTION_FAT'] = \
            outdoor_crops.OG_ROTATION_FRACTION_FAT
        constants['OG_ROTATION_FRACTION_PROTEIN'] = \
            outdoor_crops.OG_ROTATION_FRACTION_PROTEIN

        constants['MEAT_FRACTION_FAT'] = \
            meat_and_dairy.MEAT_FRACTION_FAT
        constants['MEAT_FRACTION_PROTEIN'] = \
            meat_and_dairy.MEAT_FRACTION_PROTEIN
        ...
        constants["KG_PER_SMALL_ANIMAL"] = \
            meat_and_dairy.KG_PER_SMALL_ANIMAL
        constants["KG_PER_MEDIUM_ANIMAL"] = \
            meat_and_dairy.KG_PER_MEDIUM_ANIMAL
        constants["KG_PER_LARGE_ANIMAL"] = \
            meat_and_dairy.KG_PER_LARGE_ANIMAL

        constants["LARGE_ANIMAL_KCALS_PER_KG"] = \
            meat_and_dairy.LARGE_ANIMAL_KCALS_PER_KG
        constants["LARGE_ANIMAL_FAT_PER_KG"] = \
            meat_and_dairy.LARGE_ANIMAL_FAT_PER_KG
        constants["LARGE_ANIMAL_PROTEIN_PER_KG"] = \
            meat_and_dairy.LARGE_ANIMAL_PROTEIN_PER_KG

        constants["MEDIUM_ANIMAL_KCALS_PER_KG"] = \
            meat_and_dairy.MEDIUM_ANIMAL_KCALS_PER_KG
        constants["MEDIUM_ANIMAL_FAT_PER_KG"] = \
            meat_and_dairy.MEDIUM_ANIMAL_FAT_PER_KG
        constants["MEDIUM_ANIMAL_PROTEIN_PER_KG"] = \
            meat_and_dairy.MEDIUM_ANIMAL_PROTEIN_PER_KG

        constants["SMALL_ANIMAL_KCALS_PER_KG"] = \
            meat_and_dairy.SMALL_ANIMAL_KCALS_PER_KG
        constants["SMALL_ANIMAL_FAT_PER_KG"] = \
            meat_and_dairy.SMALL_ANIMAL_FAT_PER_KG
        constants["SMALL_ANIMAL_PROTEIN_PER_KG"] = \
    ...
    def print_constants(self,constants,time_consts):
        ...
        print(100 * CFP * OG_RF_PROTEIN / 1e3 \
        ...
        if(self.feed_shutoff_kcals[0] > 0):
            ...
            if(CPM > 0):
                ...
                print(100 * self.chicken_pork_fat[0] \
                    / 1e3 / (CPM * 1e9 / 4e6 / 1e6))
                print("INITIAL_CH_PK_PROTEIN percentage")
                print(100 * self.chicken_pork_protein[0] / 1e3 \
                    / (CPM * 1e9 / 4e6 / 1e6))
                print("")
            else:
            ...
            if(CM_IN_KCALS > 0):
                ...
                print(100 * CM_IN_PROTEIN / 1e3 \
                    / (CM_IN_KCALS * 1e9 / 4e6 / 1e6))
                print("")
            else:
        ...
        if(constants['ADD_DAIRY']):
            ...
            print(100 * dairy_milk_fat / (1 - DAIRY_WASTE / 100) / 1e3 /
                  (dairy_milk_kcals / (1 - DAIRY_WASTE / 100) \
                    * 1e9 / 4e6 / 1e6))
        ...
        if(constants['ADD_FISH']):
            ...
            production_kcals_fish_per_month = \
                time_consts['production_kcals_fish_per_month'][0]
            production_fat_fish_per_month = \
                time_consts['production_fat_fish_per_month'][0]
            production_protein_fish_per_month = \
                time_consts['production_protein_fish_per_month'][0]

            print("INITIAL_FISH_KCALS million tons dry caloric monthly")
            print(
                production_kcals_fish_per_month / (1 - FISH_WASTE / 100) \
                    * 1e9 / 4e6 / 1e6)

            print("INITIAL_FISH_PROTEIN million tons monthly")
            print(production_protein_fish_per_month / \
                (1 - FISH_WASTE / 100) / 1e3)
            ...
            print(100 * production_fat_fish_per_month \
                / (1 - FISH_WASTE / 100) / 1e3 / (
                production_kcals_fish_per_month \
                / (1 - FISH_WASTE / 100) * 1e9 / 4e6 / 1e6))
            print("INITIAL_FISH_PROTEIN percentage")
            print(100 * production_protein_fish_per_month \
                / (1 - FISH_WASTE / 100) / 1e3 / (
                production_kcals_fish_per_month \
                / (1 - FISH_WASTE / 100) * 1e9 / 4e6 / 1e6))
            print("")
