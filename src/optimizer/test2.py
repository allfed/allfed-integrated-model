...
model += Humans_Fed_Kcals_0 - 0.00308085107113*SF_Eaten_During_Month_0 == -120.664598978
...
model += 0.00308085107113*SF_Eaten_During_Month_0 >= 164.32022395
# model += 0.0332618713195*SF_Eaten_During_Month_0 >= 1615.381075

model += Humans_Fed_Kcals_1 - 0.00308085107113*SF_Eaten_During_Month_1 == -80.0846480201
...
model += 0.00308085107113*SF_Eaten_During_Month_1 >= 123.740272992
# model += 0.0332618713195*SF_Eaten_During_Month_1 >= 1569.71365833
