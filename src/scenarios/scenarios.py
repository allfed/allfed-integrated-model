...
class Scenarios:
    ...
    def init_country_food_system_properties(self,country_data):
        ...
        inputs_to_optimizer['BASELINE_CROP_KCALS'] = \
            country_data['crop_kcals']

        # annual tons fat
        inputs_to_optimizer['BASELINE_CROP_FAT'] = \
            country_data['crop_fat']

        # annual tons protein
        inputs_to_optimizer['BASELINE_CROP_PROTEIN'] = \
            country_data['crop_protein']


        # annual tons dry carb equivalent
        inputs_to_optimizer['BIOFUEL_KCALS'] = \
            country_data['biofuel_kcals']

        # annual tons fat
        inputs_to_optimizer['BIOFUEL_FAT'] = \
            country_data['biofuel_fat']

        # annual tons protein
        inputs_to_optimizer['BIOFUEL_PROTEIN'] = \
            country_data['biofuel_protein']


        # annual tons dry carb equivalent
        inputs_to_optimizer['FEED_KCALS'] = \
            country_data['feed_kcals']

        # annual tons fat
        inputs_to_optimizer['FEED_FAT'] = \
            country_data['feed_fat']

        # annual tons protein
        inputs_to_optimizer['FEED_PROTEIN'] = \
            country_data['feed_protein']


        # total head count of milk cattle
        inputs_to_optimizer['INITIAL_MILK_CATTLE'] = \
            country_data['dairy_cows']

        # total head count of small sized animals
        inputs_to_optimizer['INIT_SMALL_ANIMALS'] = \
            country_data['small_animals']

        # total head count of medium sized animals
        inputs_to_optimizer['INIT_MEDIUM_ANIMALS'] = \
            country_data['medium_animals']

        # total head count of large sized animals minus milk cows
        inputs_to_optimizer['INIT_LARGE_ANIMALS_WITH_MILK_COWS'] = \
            country_data['large_animals']


        # fish kcals per month, billions
        inputs_to_optimizer["FISH_DRY_CALORIC_ANNUAL"] = \
            country_data['aq_kcals']
        ...
        inputs_to_optimizer["FISH_PROTEIN_TONS_ANNUAL"] = \
            country_data['aq_protein']


        # annual tons milk production
        inputs_to_optimizer['TONS_DAIRY_ANNUAL'] = \
            country_data['dairy']
        ...
        # annual tons cattle beef production
        inputs_to_optimizer['TONS_BEEF_ANNUAL'] = \
            country_data['beef']
