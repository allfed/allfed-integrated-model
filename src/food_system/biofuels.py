...
class Biofuels:
    ...
    def get_biofuel_usage(self,inputs_to_optimizer):
        ...
        self.BIOFUEL_MONTHLY_USAGE_KCALS = self.BIOFUEL_KCALS / 12 * 4e6 / 1e9  # billions kcals
        self.BIOFUEL_MONTHLY_USAGE_FAT = self.BIOFUEL_FAT / 12 / 1e3  # thousand tons
        self.BIOFUEL_MONTHLY_USAGE_PROTEIN = self.BIOFUEL_PROTEIN / 12 / 1e3  # thousand tons
        ...
        self.biofuels_kcals = [self.BIOFUEL_MONTHLY_USAGE_KCALS] * \
            biofuel_delay + [0] * (self.NMONTHS-biofuel_delay)
        self.biofuels_fat = [self.BIOFUEL_MONTHLY_USAGE_FAT] * \
            biofuel_delay + [0] * (self.NMONTHS-biofuel_delay)
        self.biofuels_protein = [self.BIOFUEL_MONTHLY_USAGE_PROTEIN] * \
            biofuel_delay + [0] * (self.NMONTHS-biofuel_delay)
