...
avg = create_nuclear_winter_csv.average_percentages([1, 2, 3])
...
avg = create_nuclear_winter_csv.weighted_average_percentages(
...
avg = create_nuclear_winter_csv.average_percentages([1e11, -101, 1e8, 1e26])
